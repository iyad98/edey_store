...
@section('content')
    ...
    <div class="content_innerPage hidden  show_empty_cart skin_bg">
        <div class="container">
            <div class="cart_empty_block cart">
                <img src="{{asset('website_v3/img/bag.svg')}}" alt="bag">
                <p>عذراً، لا يوجد منتجات في عربة التسوق</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="seller_head">
                        <div class="seller_img">
                            <img src="{{asset('website_v3/img/seller_img.svg')}}" alt="seller_img">
                        </div>
                        <div class="mcategory_seller">
                            <h3> عبد الكريم/متجر تست</h3>
                            <div class="mn_eva">
                                <p>المبيعات 20 </p>
                            </div>
                                ...
                                <td>
                                    <div class="tb_product clearfix">
                                        ...
                                        <div class="tb_txt">
                                            ...
                                            <button @click="remove_product_from_cart(product.cart_product_id)" class="btn_tb_remove"><i class="fal fa-times"></i>إزالة</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hid_lg">
                                        <div class="quantity_remove_mo">
                                            ...
                                            <button class="btn_tb_remove"><i class="fal fa-times"></i></button>
                                        </div>
                                    </div>
                                </td>
                                <td class="hide_xs">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box_bill">
                        <label class="fr_label">البيانات المالية</label>
...
{{--                                        <input type="radio" class="radio_st store_check" name="receipt" checked>--}}
{{--                                        <div class="box_check_itm_cn clearfix">--}}
{{--                                            <div class="icon_check">--}}
{{--                                                <img src="{{asset('website_v3/img/visa.svg')}}" alt="">--}}
{{--                                                <img src="{{asset('website_v3/img/master.svg')}}" alt="">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                        <div class="box_check_itm_cn clearfix">--}}
{{--                                            <div class="icon_check">--}}
{{--                                                <img src="{{asset('website_v3/img/tran_bank.svg')}}" alt="">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                        <div class="box_check_itm_cn clearfix">--}}
{{--                                            <div class="icon_check">--}}
{{--                                                <img src="{{asset('website_v3/img/mada.svg')}}" alt="">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                        <div class="box_check_itm_cn clearfix">--}}
{{--                                            <div class="icon_check">--}}
{{--                                                <img src="{{asset('website_v3/img/apple-pay.svg')}}" alt="">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                        ...
                        <div class="bill_details">
                            ...
                            <div class="bill_ft">
                                <div class="total_rw_bill d-flex align-items-center">
                                    <h3>الإجمالي</h3>
                                    <p class="mr-auto">@{{cart_data.total_price }}<span>@{{ cart_data.currency }}</span>
                                    </p>
                                </div>
                            </div>
