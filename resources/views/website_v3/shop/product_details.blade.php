    ...
    <div id="product_details_vue" class="content_innerPage">
        <div class="container">
            ...
            <div class="row">
                ...
                {{--                                        <img :src="image" alt="">--}}
                {{--                                        <a data-fancybox="images" :href="image" class="pro_bThumb_fancy"><i--}}
                {{--                                                class="far fa-expand-arrows-alt"></i></a>--}}
                {{--                                    </div>--}}
                {{--                                </div>--}}
                ...
                <div class="col-md-7">
                    <div class="details_mproduct">
                        ...
                        <div class="mcategory_seller">
                            <h3>@{{ product.name }}</h3>
                            <h3>إسم التاجر : @{{ product.merchant.store_name }} </h3>
                            <div class="mn_eva">
                                <p>المبيعات 20 </p>
                            </div>
                        </div>
                            ...
                            <div class="rw_sale_sku d-flex align-items-center">
                                <div class="mproduct_sale">
                                    ...
                                    <div class="mproduct_sale">
                                        ...
                                        <p v-if="product.is_discount" class="mold_sale">@{{ product.price }} @{{
                                            product.currency }}</p>
                                    </div>
                                    ...
                                    <div v-if="attribute.key == 'color'" class="list_type_check checks_group">
                                        <div v-for="attribute_value in attribute.attribute_values" class="itm_check_tp">
                                            ...
                                            <div class="label_title_ch ch_color"
                                                 :for="'myCheckboxColor'+attribute_value.id"
                                                 v-text="attribute_value.name"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div v-if="attribute.key == 'label'" class="list_type_check checks_group">
                                        <div v-for="attribute_value in attribute.attribute_values" class="itm_check_tp">
                                            ...
                                            <div class="label_title_ch ch_size"
                                                 :for="'myCheckboxSize'+attribute_value.id"
                                                 v-text="attribute_value.name"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="inscriptions_list checks_group">
                                        ...
                                        <div v-for="attribute_value in attribute.attribute_values"
                                            ...
                                            <div class="inscription_label">
                                                <img :for="'myImage'+attribute_value.id" :src="attribute_value.value"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mproduct_action">
                                ...
                                <div class="m_product_action_list clearfix">
                                    <div class="ac_itm quantity_acp">
                                        <div class="quantity">
                                            <input type="text" name="count-quat1" :value="product.quantity_cart"
                                                   class="jsQuantity count-quat " :class="'get_quantity'+(product.id)">
                                    ...
                                    <div v-if="!product.in_cart" class="ac_itm addCart_acp"
                                         @click="add_to_cart_vue(product.id , -1)">
                                        <button class="btn m_pro_addCart " :class="'add_to_cart_'+(product.id)"><i
...
{{--                                        <div class="ac_itm compare_acp">--}}
                                        {{--                                            <a href="javascript:;" class="btn compare_btn "--}}
                                        {{--                                               :class="'add_to_compare_'+(product.id)"--}}
                                        {{--                                               @click="add_to_compare(product.id)"><i class="fas fa-exchange-alt"></i>مقارنة</a>--}}
                                        {{--                                        </div>--}}
                                        <div class="ac_itm add_fav_acp">
                                            <a v-if="product.in_favorite"
                                               onclick="add_to_wishlist(product.id , product.in_favorite)"
                                               :class="'wishlist_comp_'+product.id"
                                               class="btn btn_add_fav btn_added_fav"><i class="far fa-heart"></i></a>
                                            <a v-if="!product.in_favorite"
                                               onclick="add_to_wishlist(product.id , product.in_favorite)"
                                               :class="'wishlist_comp_'+product.id" class="btn btn_add_fav"><i
...
@section('js')
    ...
    <script src="{{asset('website_v3/js/lightslider.min.js')}}"></script>
    ...
    <script src="{{asset('website_v3/general/js/product/product_details.js')}}" type="text/javascript"></script>
