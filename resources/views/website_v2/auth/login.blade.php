                        ...
                        <div class="cn_sign_layout">
                            ...
                            <div class="alert alert-danger dan_alert hidden" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email"  v-model="login.email" @keyup.enter="login_user" class="form-control" placeholder="البريد الالكتروني">
                                </div>
                                <div class="form-group">
                                    <div class="cn_label  d-flex align-items-center">
                                        <label class="fr_label">كلمة المرور</label>
                                        <div class="pass_left mr-auto">
                                            <a href="#forget_password" data-toggle="modal" class="forget_password">هل نسيت كلمة المرور؟</a>
                                        </div>
                                    </div>
                                    <div class="password_input">
                                        <input type="password" v-model="login.password"  @keyup.enter="login_user" class="form-control pwd" placeholder="كلمة المرور">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal_body">
                        ...
                        <div class="alert alert-danger dan_alert1 hidden" role="alert">
                            ...
                            <div class="form-group">
                                <label class="fr_label">البريد الالكتروني</label>
                                <input type="email" v-model="email_forget_password" name="email" class="form-control" placeholder="البريد الالكتروني">
                            </div>
                        <input type="hidden" name="_wp_http_referer"
                               value="/my-account/"/>
                            <button type="submit" @click="send_email_for_forget_passeord" class="btn btn_prim btn_dt send_email">
                                إرسال
