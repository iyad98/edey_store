...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%; max-width:650px; margin:auto;">
        ...
        <td style="padding: 20px 20px;background-color: #fff; border-top-right-radius: 15px;border-top-left-radius: 15px;" class="td_padding">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="left">
                        <a href="#" class="img-logo">
                            <img src="https://www.q8store.co/email/images/done.png" style="height: 100px;" alt="">
                        </a>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td width="100%" style="padding: 5px 20px;background: #e81f34;color: #fff;font-weight: 700;"><p style="margin: 0;">{{trans('website.thank_you_for_order' , [] , isset($_lang_) ? $_lang_ : 'ar' )}}</p></td>
    </tr>
    <tr>
        <td style="padding: 30px 20px;background-color: #fff; " class="td_padding">
            <p style="color: #000; font-size: 15px;">{!! $get_new_text !!}</p>
