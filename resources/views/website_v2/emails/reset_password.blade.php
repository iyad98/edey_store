...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%; max-width:650px; margin:auto; background-color: #fff;">
    ...
    <tr>
        <td style="padding: 30px 20px; background-color: #E81F34;" class="td_padding" align="center">
            ...
            <h2 style="color: #ffffff; font-size: 24px; font-weight: 700;">إعادة تعيين كلمة المرور</h2>
            <p style="color: #ffffff; font-size: 16px; line-height: 1.5;">  لقد طلبت إعادة تعيين كلمة المرور يمكنك من خلال الضغط على الزر أدناه</p>
...
color: #e81f34;" target="_blank" >إعادة تعيين كلمة المرور</a>
