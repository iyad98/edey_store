...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%; max-width:650px; margin:auto; background-color: #fff;">
    ...
    <tr>
        <td style="padding: 30px 20px; background-color: #E81F34;" class="td_padding" align="center">
            ...
            <h2 style="color: #ffffff; font-size: 24px; font-weight: 700;">{{$_subject_}}</h2>
            <p style="color: #ffffff; font-size: 16px; line-height: 1.5;">  {!! $_message_ !!}	</p>
            {{--<a href="#" style="padding: 10px 30px; border-radius: 5px; background-color: #FFD400; color: #000000; font-size: 18px; font-weight: 700; display: inline-block; text-decoration: none;">تتبع الشحنة</a>--}}
        </td>
    </tr>
    {{--<tr>--}}
