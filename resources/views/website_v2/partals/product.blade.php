        ...
        <div class="cn_product_txt">
            ...
            <a href="{{LaravelLocalization::localizeUrl('products')}}/{{$product['id']}}" class="btn btn_add_cart cart_aded ">في عربة التسوق</a>
                ...
                @else
                    ...
                    @else
                    <a onclick="add_to_cart('{{$product['id']}}',1,[],0,0,1 , 1)" href="javascript:;" class="btn btn_add_cart add_to_cart_{{$product['id']}} ">

                        أضف إلى عربة التسوق
                        <div class="spinner-border text-light spinner_cart_{{$product['id']}} hidden" role="status">
