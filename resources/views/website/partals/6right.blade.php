...
<div class="girl-clothes">
    <div class="container">
        ...
        <div class="whole-section">
            ...
            <div class="sale" style="margin-left: 19px; margin-right: 0px">
            ...
            <div class="products-section">
                ...
                <div id="carouselExampleIndicators2" class="carousel slide d-none d-md-block" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php $index  = 0 ;?>

                        @foreach($products  as $k => $product)
                            @if($k % 6 == 0)
                                <li data-target="#carouselExampleIndicators2" data-slide-to="{{$index}}" class="  @if($k == 0) active  @endif"></li>
                                <?php $index  = $index + 1 ;?>
                            @endif
                        @endforeach
