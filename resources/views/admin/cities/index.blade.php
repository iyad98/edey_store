...
@section('content')
    ...
    <div class="m-content" id="app">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text"
                            v-text="add ? '{{trans('admin.new_city')}}' : '{{trans('admin.edit_city')}}'">
                        </h3>
                    </div>
                </div>
            </div>
        ...
        @include('admin.cities.include.form_')
        ...
        <div class="m-portlet m-portlet--mobile show_data">
            <div class="m-portlet__body">
                ...
                <div class="row top_row">
                    ...
                    <div class="col-sm-4">
                            @check_role('add_cities')
                                <a href="javascript:;" id="add_new_city"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped table-bordered table-hover table-checkabl nowrap_tablee" id="city-table">
                    <thead>
                    <tr>
                        <th>
                            <div class="row">
...
@push('js')
    ...
    <script src="{{url('')}}/admin_assets/assets/general/js/cities/list.js"
            type="text/javascript"></script>


    <script src="{{url('')}}/admin_assets/assets/general/js/cities/city.js"
            type="text/javascript"></script>
