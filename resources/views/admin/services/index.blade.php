...
@section('content')
    ...
    <div class="m-content" id="app">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text"
                            v-text="add ? '{{trans('admin.new_services')}}' : '{{trans('admin.edit_services')}}'">
                        </h3>
                    </div>
                </div>
            </div>
        ...
        @include('admin.services.include.form_')
        ...
        <div class="m-portlet__body">
            ...
            <div class="row top_row">
                ...
                <div class="col-sm-4">
                    @check_role('add_services')
                    <a href="javascript:;" id="add_new_services"
            ...
            <!--begin: Datatable -->
            <table class="table table-striped table-bordered table-hover table-checkable nowrap_table" id="services_table">
                <thead>
                <tr>
                    <th>#</th>
...
@push('js')
    ...
    <script>
        var default_image = "{{getImage('services' ,'true')}}";
    </script>
    <script src="{{url('')}}/admin_assets/assets/vendors/custom/datatables/datatables.bundle.js"
            type="text/javascript"></script>

    <script src="{{url('')}}/admin_assets/assets/general/js/services/list.js"
            type="text/javascript"></script>


    <script src="{{url('')}}/admin_assets/assets/general/js/services/services.js"
            type="text/javascript"></script>
