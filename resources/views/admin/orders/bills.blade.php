...
@foreach( $orders as $order)
    <div class="panel-wrap woocommerce " >
        <div style=" min-height: 80px;    margin-bottom: 34px; position: relative" id="order_data" class="panel ">
            <h2 style="top: 40px;
position: absolute;
left: 20;">رقم التسجيل الضريبي : 310184418800003</h2>
            <h2 style="top: 40px;position: relative;">رقم الفاتورة: {{$order->id}}</h2>
            <h2 style="top: 40px;position: relative;">رقم فاتوره اسواق: {{$order->invoice_number}}</h2>
            ...
            <span style=" position: relative;left: 0;top: 20px;display: block;text-align: center;width: 100%;">
    ...
    <div id="woocommerce-order-items" class="postbox ">
        ...
        <div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
            <table class="wc-order-totals">
                ...
                <tr>
                    <td class="label"> الاجمالي ( يشمل ضريبة القيمة المضافة {{ $order->tax_percentage }}% ):</td>
