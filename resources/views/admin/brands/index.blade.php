...
@section('content')
    ...
    <div class="m-content" id="app">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text"
                            v-text="add ? '{{trans('admin.new_brand')}}' : '{{trans('admin.edit_brand')}}'">
                        </h3>
                    </div>
                </div>
            </div>
        ...
        @include('admin.brands.include.form_')
        ...
        <div class="m-portlet__body">
            ...
            <div class="row top_row">
                ...
                <div class="col-sm-4">
                    @check_role('add_brands')
                    <a href="javascript:;" id="add_new_brand"
            ...
            <!--begin: Datatable -->
            <table class="table table-striped table-bordered table-hover table-checkable nowrap_table" id="brand-table">
                <thead>
                <tr>
                    <th>#</th>
...
@push('js')
    ...
    <script>
        var default_image = "{{getImage('brands' ,'true')}}";
    </script>
    <script src="{{url('')}}/admin_assets/assets/vendors/custom/datatables/datatables.bundle.js"
            type="text/javascript"></script>

    <script src="{{url('')}}/admin_assets/assets/general/js/brands/list.js"
            type="text/javascript"></script>


    <script src="{{url('')}}/admin_assets/assets/general/js/brands/brands.js"
            type="text/javascript"></script>
