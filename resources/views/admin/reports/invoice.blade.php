...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            $('#print_excel').click(function () {
                ...
                let url = "{{url('admin/download-excel-invoice-bill')}}" + "?status=" + status + "&payment_method=" + payment_method
            ...
            $('#print_').click(function () {
                ...
                let date_from = $('#date_from').val();
                let date_to = $('#date_to').val();
                let url = "{{url('admin/print-invoice')}}" + "?status=" + status + "&payment_method=" + payment_method
                    + "&date_from=" + date_from + "&date_to=" + date_to;
    ...
    <script src="{{url('')}}/admin_assets/assets/general/js/reports/invoice.js"
            type="text/javascript"></script>
