            ...
            <div class="m-portlet__body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable responsive no-wrap"
                    ...
                    <tr>
                        ...
                        <th>{{trans('admin.product_name_')}}</th>
                        <th>{{trans('admin.quantity')}}</th>
                        <th>{{trans('admin.price')}}</th>
                        <th>{{trans('admin.total_discount_coupon')}}</th>
                        <th>{{trans('admin.bill_price')}}</th>
                        <th>{{trans('admin.shipping_price')}}</th>
                        <th>{{trans('admin.tax_price')}}</th>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            $('#print_excel').click(function () {
                ...
                let url = "{{url('admin/download-excel-store-bill')}}" + "?status=" + status + "&payment_method=" + payment_method
            ...
            $('#print_').click(function () {
                ...
                let date_from = $('#date_from').val();
                let date_to = $('#date_to').val();
                let url = "{{url('admin/print-store-bill')}}" + "?status=" + status + "&payment_method=" + payment_method
                    + "&date_from=" + date_from + "&date_to=" + date_to;
    ...
    <script src="{{url('')}}/admin_assets/assets/general/js/reports/store_bill_list.js"
            type="text/javascript"></script>
