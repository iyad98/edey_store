...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{trans('admin.admin_notifications')}}</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{route('admin.notifications.index')}}" class="m-nav__link">

                            <span class="m-nav__link-text">{{trans('admin.admin_notifications')}}</span>
                        </a>
                    </li>
...
@push('js')
    ...
    <script src="{{url('')}}/admin_assets/assets/general/js/admin_notifications/list.js"
            type="text/javascript"></script>
