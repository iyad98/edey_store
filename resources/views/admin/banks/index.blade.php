...
@section('content')
    ...
    <div class="m-content" id="app">
        ...
        @include('admin.banks.include.form_')
            ...
            <div class="m-portlet__body">
                ...
                <div class="row top_row">
                    ...
                    <div class="col-sm-4">
                        ...
                        @check_role('add_banks')
                        <a href="javascript:;" id="add_new_bank"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped table-bordered table-hover table-checkable nowrap_table" id="bank-table">
                    <thead>
                    <tr>
                        <th>#</th>
...
@push('js')
    ...
    <script src="{{url('')}}/admin_assets/assets/general/js/banks/list.js"
            type="text/javascript"></script>


    <script src="{{url('')}}/admin_assets/assets/general/js/banks/banks.js"
            type="text/javascript"></script>
