    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row top_row">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" class="form-control m-input" v-model="attribute.name_ar"
                       v-validate="'required'"
            ...
            <div class="col-lg-4">
                ...
                <input type="text" class="form-control m-input" v-model="attribute.name_en"
                       {{-- v-validate="'required'" --}}
            ...
            <div class="col-lg-4">
                <label>{{trans('admin.attribute_type')}}:</label>
                <br>
