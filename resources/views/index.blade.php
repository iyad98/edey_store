...
<head>
    ...
    <link rel="stylesheet" href="{{url('')}}/website/css/bootstrap/rtl/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('')}}/website/css/vendor/xmcountdown.css">
...
<header>
    <div id="header-top-wrap">
        ...
        <section id="header-top" class="clearfix">
            ...
            <p class="miniTitle">
                المتجر الاول في عالم المكياج والعناية
            </p>
        </section>
        <!-- /HEADER TOP -->
    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="navActions">
                            <a href="#" class="iconsTop1">
                                <img class="navImage" alt="cart" src="{{url('')}}/website/images/n1.png">
                                <span>سلة الشراء</span>
                            </a>
                            <a href="#" class="iconsTop2">
                                <img class="navImage" alt="cart" src="{{url('')}}/website/images/n2.png">
                                <span>الإعجاب</span>
                            </a>
                            <div class="iconsTop3">
                                <img class="navImage" alt="cart" src="{{url('')}}/website/images/n3.png">
                                <select class="form-group" id="lang">
                                    <option>AR</option>
                                    <option>EN</option>
                                </select>
                            </div>
                            <div class="iconsTop4">
                                <img class="navImage" alt="cart" src="{{url('')}}/website/images/n4.png">
                                <select class="form-group" id="lang">
                                    <option disabled selected>حسابي</option>
                    ...
                    <div class="col-md-4">
                        <figure class="logo">
                            <a href="index.html"><img src="{{url('')}}/website/images/logo.png" alt="logo" width="160px"></a>
                            <figcaption>Raqee</figcaption>
                        </figure>
                    </div>
                    <div class="col-md-4">
                        <form>
...
<nav class="mobile-menu">
    <img src="{{url('')}}/website/images/logo2.png" alt="logo" width="100%">
    <!-- SVG PLUS -->
    ...
    <ul>
        ...
        <li>
            <a href="#">اللينك الأخير</a>
        </li>
        <li>
            <a href="#"><span>اللغة العربية</span>
                <!-- SVG ARROW -->
                <svg class="svg-arrow">
                    <use xlink:href="#svg-arrow"></use>
                </svg>
        ...
        <li>
            <a href="#"><span>العملة: الريال السعودي</span>
                <!-- SVG ARROW -->
                <svg class="svg-arrow">
                    <use xlink:href="#svg-arrow"></use>
                </svg>
...
<!-- MAIN MENU -->
<nav id="main-menu">
    <img class="pull-nav" src="{{url('')}}/website/images/icons/pull-icon.png" alt="pull-icon">
    <ul class="menu_ul">
        <li><a href="index.html">الرئيسية</a></li>
        <li class="cateNav">
            <a href="#" class="submenu">المكياج</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
                </li>
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
                </li>
                <!--<li>
                    <a href="#">يوجد أقسام فرعية
                        <svg class="svg-arrow">
                            <use xlink:href="#svg-arrow"></use>
                        </svg>
                    </a>
        ...
        <li class="cateNav">
            <a href="#" class="submenu">العناية</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
        ...
        <li class="cateNav">
            <a href="#" class="submenu">الأظافر</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
        ...
        <li class="cateNav">
            <a href="#" class="submenu">العدسات</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
        ...
        <li class="cateNav">
            <a href="#" class="submenu">الأجهزة</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
        ...
        <li class="cateNav">
            <a href="#" class="submenu">الماركات</a>
            <!-- SUBMENU SMALL -->
            <ul class="submenu-small">
                <li>
                    <a href="index.html">عنصر داخلي هنا</a>
        ...
        <li><a href="index.html">مدونة راق</a></li>
    </ul>
</nav>
<!-- /MAIN MENU -->
...
<div id="banner-wrap">
    <div class="container-fluid">
        <div class="row">
            ...
            ####################################################
            -->
            <div id="carousel" class="container carousel slide carousel-fade" data-ride="carousel" data-interval="2000">
                <div class="col-md-12">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <a href="#">
                                <picture>
                                    <source srcset="{{url('')}}/website/images/slider.png" media="(min-width: 1400px)">
                                    <source srcset="{{url('')}}/website/images/slider.png" media="(min-width: 769px)">
                                    <source srcset="{{url('')}}/website/images/slider.png" media="(min-width: 577px)">
                                    <img srcset="{{url('')}}/website/images/slider.png" alt="responsive image" class="d-block img-fluid">
                                </picture>
                                <!--
                                                            <div class="carousel-caption">
                                                                <div>
                                                                    <h4>ابني جسدك</h4>
                                                                    <h2>بالمكملات الغذائية المناسبة</h2>
                                                                    <p>خصومات تصل الى 45% عند شرائك بقيمة 500 ريال!</p>
                                                                </div>
                                                            </div>
                                -->
                            </a>
...
<section id="grid_layout">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="fullImage">
                    <a href="#"><img src="{{url('')}}/website/images/full1.png" alt="fullimage"></a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="fullImage">
                    <a href="#"><img src="{{url('')}}/website/images/full2.png" alt="fullimage"></a>
                </div>
            </div>
        </div>
    </div>
...
<section id="all_products">
    <div class="container">
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">جديدنا</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
            ...
            <div class="col-md-1 moreCol">
                <a href="#">المزيد <img src="{{url('')}}/website/images/more.png" width="20px;"></a>
            </div>
        ...
        <div class="row mb-20">
            <div class="col-md-3">
                <div class="product-list">
                    ...
                    <div class="list-item">
                        ...
                        <!-- /PIN -->
                        <!-- PIN -->
                        <div class="pin circle2">
                            <span>يشمل العرض</span>
                        </div>
                        <!-- /PIN -->
                        <!-- PIN -->
                        <div class="pin circle3">
                        ...
                        <div class="actions">
                            <figure class="liquid">
                                <img src="{{url('')}}/website/images/items/35.png" alt="product1">
                            </figure>
                        </div>
                        <!-- /ACTIONS -->
                        ...
                        <div class="description">
                            ...
                            <!-- /RATING -->
                            <div class="clearfix">
                                <a href="#"><h6>هنا يتم وضع اسم المنتج</h6></a>
                            </div>
                            <div class="clearfix prices">
                                <p class="highlighted previous">SAR 2.50</p>
                                <p class="highlighted current">SAR 2.00</p>
            ...
            <div class="col-md-3">
                <div class="product-list">
                    ...
                    <div class="list-item">
                        <!-- PIN -->
                        <div class="pin circle circle_black">
                            <span>جديد</span>
                        </div>
                        <!-- /PIN -->
                        <!-- PIN -->
                        ...
                        <!-- /PIN -->
                        <!-- PIN -->
                        <div class="pin circle3 circle_gray">
        ...
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">الأكثر مبيعاً</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
...
<section id="face_product">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="fullImage_banner">
                    <a href="#"><img src="{{url('')}}/website/images/banner1.png" alt="fullimage"></a>
                </div>
            </div>
...
<section id="all_products">
    <div class="container">
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">المكياج</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
        ...
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">العناية</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
...
<section id="all_products">
    <div class="container">
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">العطور</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
        ...
        <div class="row mb-20">
            <div class="col-md-2">
                <div class="title_gp2">
                    <span class="subtitle">الأجهزة</span>
                </div>
            </div>
            <div class="col-md-9">
                <div class="title_gp">
    ...
    <section id="brands">
        <div class="slidable">
            ...
            <ul id="owl-brands" class="brands-list owl-carousel">
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/1.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/2.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/3.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/4.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/5.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
                ...
                <li>
                    <a href="#">
                        <img src="{{url('')}}/website/images/brands/6.png" alt="brand-normal">
                    </a>
                </li>
                <!-- /BRAND -->
...
<footer>
    <div id="footer-top-wrap">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <img src="{{url('')}}/website/images/logoF.png" alt="logo" class="logoF">
                </div>
                <div class="col-md-2">
                    <h5 class="footerT"> معلومات <img src="{{url('')}}/website/images/arrowD.png" class="arrowD"> </h5>
                    <ul class="footerUL">
                ...
                <div class="col-md-2">
                    <h5 class="footerT"> إضافــــــات <img src="{{url('')}}/website/images/arrowD.png" class="arrowD"> </h5>
                    <ul class="footerUL">
                        <li><a href="#"> ماركات</a></li>
                        <li><a href="#">نموذج اشعار التحويل</a></li>
                        <li><a href="#">الحسابات البنكية</a></li>
                        <li><a href="#">سياسة الخصوصية</a></li>
                    </ul>
                </div>
                <div class="col-md-2">
                    <h5 class="footerT"> حســــــــابي <img src="{{url('')}}/website/images/arrowD.png" class="arrowD"> </h5>
                    <ul class="footerUL">
                ...
                <div class="col-md-2">
                    <h5 class="footerT"> عن المتجر <img src="{{url('')}}/website/images/arrowD.png" class="arrowD"> </h5>
                    <ul class="footerUL">
                        <li><img src="{{url('')}}/website/images/f1.png" class="fICON"><a href="#">المملكة العربية السعودية</a></li>
                        <li><img src="{{url('')}}/website/images/f2.png" class="fICON"><a href="#">00966544922230</a></li>
                        <li><img src="{{url('')}}/website/images/f3.png" class="fICON"><a href="#"> info@raqshop.com</a></li>
                    </ul>
                </div>
                <div class="col-md-2">
                    <h5 class="footerT"> حمل التطبيق <img src="{{url('')}}/website/images/arrowD.png" class="arrowD"> </h5>
                    <br>
                    <a href="#"><img src="{{url('')}}/website/images/apple.png" class="StoreIcons"></a>
                    <a href="#"><img src="{{url('')}}/website/images/google.png" class="StoreIcons"></a>
                </div>
            </div>
        </div>
    </div>
    <div id="footer-bottom-wrap">
        <section id="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p>جميع الحقوق محفوظة لمتجر راق 2020</p>
                    </div>
                    <div class="col-md-4 siconCol">
                        <a href="#"><img src="{{url('')}}/website/images/s1.png" class="bottomIcons"></a>
                        <a href="#"><img src="{{url('')}}/website/images/s2.png" class="bottomIcons"></a>
                        <a href="#"><img src="{{url('')}}/website/images/s3.png" class="bottomIcons"></a>
                        <a href="#"><img src="{{url('')}}/website/images/s4.png" class="bottomIcons"></a>
                    </div>
                    <div class="col-md-4">
                        <!-- PAYMENT METHODS -->
                        <ul class="payment-methods">
                            <!-- METHOD -->
                            <li>
                                <img src="{{url('')}}/website/images/payment/1.png" alt="method1">
                            </li>
                            <!-- /METHOD -->

                            <!-- METHOD -->
                            <li>
                                <img src="{{url('')}}/website/images/payment/2.png" alt="method2">
                            </li>
                            <!-- /METHOD -->

                            <!-- METHOD -->
                            <li>
                                <img src="{{url('')}}/website/images/payment/3.png" alt="method3">
                            </li>
                            <!-- /METHOD -->

                            <!-- METHOD -->
                            <li>
                                <img src="{{url('')}}/website/images/payment/4.png" alt="method4">
                            </li>
                            <!-- /METHOD -->

                            <!-- METHOD -->
                            <li>
                                <img src="{{url('')}}/website/images/payment/5.png" alt="method5">
                            </li>
                            <!-- /METHOD -->
                        </ul>
                        <!-- /PAYMENT METHODS -->
...
<!-- jQuery -->
<!--<script src="{{url('')}}/website/js/vendor/jquery-1.11.1.min.js"></script>-->

<script src="{{url('')}}/website/js/vendor/jquery-2.2.4.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.{{url('')}}/website/js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
...
<!-- Header -->
<script src="{{url('')}}/website/js/header.js"></script>
<!-- Menu -->
<script src="{{url('')}}/website/js/menu.js"></script>
<!-- Home -->
<script src="{{url('')}}/website/js/home.js"></script>
<!-- Countdown -->
<script src="{{url('')}}/website/js/vendor/jquery.xmcountdown-s.min.js"></script>
<!-- Coming Soon -->
<script src="{{url('')}}/website/js/coming-soon.js"></script>
<!--
    <script>
