...
class ProductSimpleResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $data = [
            ...
            'min_quantity' => $this->variation ? $this->variation->min_quantity : 1,
            ...
            'attributes_color' => $this->is_variation == 0 ? [] : ProductAttributeResource::collection($this->attributes_color),
