        ...
        init: function () {
            ...
            !function () {
                ...
                if (0 != $("#m_dashboard_daterangepicker").length) {
                    var e = $("#m_dashboard_daterangepicker"), t = moment().subtract(29, "days"), a = moment();
                    e.daterangepicker({
                ...
                function r(t, a, r) {
                    ...
                    var o = "", n = "";
                    a - t < 100 || "Today" == r ? (o = "Today:", n = t.format("YYYY-MM-DD")) : "Yesterday" == r ? (o = "Yesterday:", n = t.format("YYYY-MM-DD")) : n = t.format("YYYY-MM-DD") + " - " + a.format("YYYY-MM-DD"), e.find(".m-subheader__daterange-date").html(n), e.find(".m-subheader__daterange-title").html(o)
                }
