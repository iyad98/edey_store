    ...
    init: function () {
        table_order = $("#custom-order-table").DataTable({
            ...
            columns: [
                ...
                {data: "sku_products" , width: "300", orderable : false  } ,
                {data: "name_products" , width: "300" , orderable : false } ,
                {data : "products_quantity_count" , orderable : false },
